      ...
      <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5">
        <div className="rounded-xl border border-slate-200 bg-[#F8FAFC] p-4">
          <ToggleRow
            icon={Bot}
            label="Coach"
            description="Enable planning chat before drafting. Turning this off stores disableChatbot=true and chatTimeLimit=-1."
            checked={allowAI}
            onChange={handleCoachToggle}
          />

          {!allowAI && (
            <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 p-3 text-[11px] leading-relaxed text-amber-800">
              Coach chat and its related options are disabled. AI draft feedback remains controlled by its request limit.
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
          <NumberSetting
            ...
            description="0 = unlimited active Coach time. Positive values are minutes."
          ...
          >
            <div>
              ...
              <p className="mt-1 text-[11px] leading-relaxed text-slate-500">
                Convert planning chat into editable notes at drafting step. Requires Coach.
              </p>
            </div>
          ...
          <NumberSetting
            ...
            description="0 disables AI draft feedback. Positive values set max checks."
