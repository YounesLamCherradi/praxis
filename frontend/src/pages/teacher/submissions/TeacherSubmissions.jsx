                ...
                <div className="rounded-3xl border border-blue-200 bg-gradient-to-br from-blue-50 to-white p-5 shadow-sm">
                  ...
                  <p className="mt-3 whitespace-pre-wrap text-sm leading-6 text-slate-700">
                    {String(
                      ...
                      "No overall teacher feedback has been added yet."}
                  </p>
                </div>
              </section>
            )}
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 max-h-[430px] space-y-3 overflow-y-auto pr-1">
                  {annotations.length === 0 ? (
                    <p className="rounded-2xl bg-slate-50 p-4 text-sm text-slate-500">
                      No teacher annotations were added.
                    </p>
                  ) : (
                    annotations.map(
                      (
...
function ReviewModalOverlay({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[2147483647] flex items-center justify-center overflow-hidden p-4 sm:p-5">
      ...
      <div className="relative z-10 flex h-[94vh] w-[min(96vw,1700px)] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-[#FBF9F6] shadow-2xl animate-fade-in-up">
            ...
            <div className="mb-3 flex shrink-0 items-start gap-3 rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 text-sky-900">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-[11px] leading-5 text-sky-800">
                  ...
                  draft, and AI checks preserved. A new teacher review can
...
export default function TeacherSubmissions({
  ...
  function handleStatusChange(nextStatus) {
    ...
    if (nextStatus === "Reopened") {
      if (
        ...
        window.alert(
          "The reopen workflow is not available in TeacherWorkspaceContext."
        );
        return;
      }
  ...
  function handleSaveReview(id, reviewData) {
    ...
    if (
      ...
      window.alert(
        "This assignment is reopened for student revision. The student must resubmit it before a new teacher review can be saved."
      );
